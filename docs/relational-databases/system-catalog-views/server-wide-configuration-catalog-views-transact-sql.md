---
description: Katalogsichten für die serverweite Konfiguration (Transact-SQL)
title: Server weite Konfigurations Katalog Sichten (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 12/01/2015
ms.prod: sql
...
ms.locfileid: "98102920"
---
# <a name="server-wide-configuration-catalog-views-transact-sql"></a>Katalogsichten für die serverweite Konfiguration (Transact-SQL)
