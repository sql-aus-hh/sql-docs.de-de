 ...
 **AES**  
 Gibt an, dass der Endpunkt den AES-Algorithmus verwenden muss. In [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] und höher ist dies die Standardeinstellung.  
