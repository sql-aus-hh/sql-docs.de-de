...
|Beispiel für einen [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] -Server mit mehreren K-Gruppen|type|Wertname|Wertdaten|  
|-----------------------------------------------------------------------------------------------------------------|----------|----------------|----------------|  
