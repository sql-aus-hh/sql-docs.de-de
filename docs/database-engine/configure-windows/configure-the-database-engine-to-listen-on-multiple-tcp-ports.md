...
description: Informationen zu TDS-Endpunkten (Tabular Data Stream, Tabellenstreamdaten) Hier erfahren Sie, wie Sie die SQL Server-Datenbank-Engine zum Lauschen an mehreren TCP-Ports verwenden.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
