...
|[Es kann keine Verbindung mit dem Verfügbarkeitsgruppenlistener in einer Umgebung mit mehreren Subnetzen hergestellt werden.](https://support.microsoft.com/kb/2792139/en-us)|Clientkonnektivität|Wenn Sie keinen Verfügbarkeitsgruppenlistener konfiguriert haben, können Sie nicht den Listener pingen oder eine Verbindung zwischen diesem und einer Anwendung herstellen.|  
|[Behandlung von Fehlern bei einem automatischen Failover](https://support.microsoft.com/kb/2833707)|Failover|Ein automatisches Failover wurde nicht erfolgreich durchgeführt.|  
